 ...
 */
require_once(SYSTEM_ROOT."epay/epay_core.function.php");
require_once(SYSTEM_ROOT."epay/epay_md5.function.php");
...
class AlipaySubmit {
	...
	*/
	function getqrcode(){
		$url = $this->alipay_gateway_api;
		$post = $this->buildRequestParaToString($para_temp);
		$response = getHttpResponsePOST($url, null, $post);
