...
<p style="text-align:center"><span style="font-weight:bold">CopyRight <i class="fa fa-heart text-danger"></i> 2020 <a href="/"><?php echo $conf['sitename']?></a></span><br/><?php echo $conf['footer']?></p>
</div>
